...
public class PipeConfig extends BaseMekanismConfig {
    ...
    public PipeConfig() {
        ...
        builder.comment("Universal Cables").push(MorePipesMod.MODID);
        ...
        builder.comment("Mechanical Pipes").push(MorePipesMod.MODID);
        ...
        builder.comment("Logistical Transporters").push(MorePipesMod.MODID);
