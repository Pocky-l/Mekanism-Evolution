 ...
 * @author Dudko Roman
 */
public class MoreLogisticalTransporter extends MoreLogisticalTransporterBase {

    private EnumColor color;

    public MoreLogisticalTransporter(IBlockProvider blockProvider, TileEntityTransmitter tile) {
    ...
    public InteractionResult onConfigure(Player player, Direction side) {
        MoreTransporterUtils.incrementColor(this);
