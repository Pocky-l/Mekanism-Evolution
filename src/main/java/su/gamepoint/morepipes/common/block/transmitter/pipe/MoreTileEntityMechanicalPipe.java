 ...
 * @author Dudko Roman
 */
public class MoreTileEntityMechanicalPipe extends MoreTileEntityTransmitter implements IComputerTile {

    private final FluidHandlerManager fluidHandlerManager;

    public MoreTileEntityMechanicalPipe(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
        super(blockProvider, pos, state);
        this.addCapabilityResolver(this.fluidHandlerManager = new FluidHandlerManager((direction) -> {
            MoreMechanicalPipe pipe = this.getTransmitter();
    ...
    protected MoreMechanicalPipe createTransmitter(IBlockProvider blockProvider) {
        return new MoreMechanicalPipe(blockProvider, this);
    }

    public MoreMechanicalPipe getTransmitter() {
        return (MoreMechanicalPipe)super.getTransmitter();
    }
