 ...
 * @author Dudko Roman
 */
public class MoreUniversalCable extends UniversalCable {
    ...
    public MoreUniversalCable(IBlockProvider blockProvider, TileEntityTransmitter tile) {
    ...
    public FloatingLong getCapacityAsFloatingLong() {
        return UCTier.getCapacityAsFloatingLong(tier);
    }
