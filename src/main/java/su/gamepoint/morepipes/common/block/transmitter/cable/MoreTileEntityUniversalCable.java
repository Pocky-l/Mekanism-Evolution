 ...
 * @author Dudko Roman
 */
public class MoreTileEntityUniversalCable extends TileEntityTransmitter implements IComputerTile {

    private final EnergyHandlerManager energyHandlerManager;

    public MoreTileEntityUniversalCable(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
        super(blockProvider, pos, state);
        addCapabilityResolver(energyHandlerManager = new EnergyHandlerManager(direction -> {
            MoreUniversalCable cable = getTransmitter();
    ...
    @Override
    protected MoreUniversalCable createTransmitter(IBlockProvider blockProvider) {
        return new MoreUniversalCable(blockProvider, this);
    }

    @Override
    public MoreUniversalCable getTransmitter() {
        return (MoreUniversalCable) super.getTransmitter();
    }
    ...
    private FloatingLong getCapacity() {
        MoreUniversalCable cable = (MoreUniversalCable) this.getTransmitter();
