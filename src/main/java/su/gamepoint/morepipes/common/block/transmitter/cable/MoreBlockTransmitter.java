 ...
 * @author Dudko Roman
 */
public abstract class MoreBlockTransmitter extends BlockMekanism implements IStateFluidLoggable {

    private static final Short2ObjectMap<VoxelShape> cachedShapes = Short2ObjectMaps.synchronize(new Short2ObjectOpenHashMap());

    protected MoreBlockTransmitter() {
        super(Properties.of(Material.PISTON).strength(1.0F, 6.0F));
    }

    protected MoreBlockTransmitter(Properties properties) {
        super(properties);
    }
