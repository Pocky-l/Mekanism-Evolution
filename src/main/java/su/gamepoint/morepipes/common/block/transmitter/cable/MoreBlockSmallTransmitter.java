 ...
 * @author Dudko Roman
 */
public class MoreBlockSmallTransmitter extends MoreBlockTransmitter {
    ...
    public MoreBlockSmallTransmitter() {
    }

    public MoreBlockSmallTransmitter(Properties properties) {
        super(properties);
    }
