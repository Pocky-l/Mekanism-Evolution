 ...
 * @author Dudko Roman
 */
public class MoreItemBlockMechanicalPipe extends ItemBlockMultipartAble<MoreBlockMechanicalPipe> {

    public MoreItemBlockMechanicalPipe(MoreBlockMechanicalPipe block) {
        super(block);
    }
