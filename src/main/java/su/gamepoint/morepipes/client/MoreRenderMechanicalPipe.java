...
public class MoreRenderMechanicalPipe extends RenderTransmitterBase<MoreTileEntityMechanicalPipe> {
    ...
    public MoreRenderMechanicalPipe(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    protected void render(MoreTileEntityMechanicalPipe tile, float partialTick, PoseStack matrix, MultiBufferSource renderer, int light, int overlayLight,
