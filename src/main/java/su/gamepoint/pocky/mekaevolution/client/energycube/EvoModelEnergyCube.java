 ...
 * @author Dudko Roman
 */
public class EvoModelEnergyCube extends MekanismJavaModel {
    public static final ModelLayerLocation CUBE_LAYER = new ModelLayerLocation(Mekanism.rl("energy_cube"), "main");
    private static final ResourceLocation CUBE_TEXTURE = new ResourceLocation(MekanismEvolutionMod.MODID, "render/energy_cube.png");
    private static final ResourceLocation OVERLAY_ON = new ResourceLocation(MekanismEvolutionMod.MODID, "render/energy_cube_overlay_on.png");
    private static final ResourceLocation OVERLAY_OFF = new ResourceLocation(MekanismEvolutionMod.MODID, "render/energy_cube_overlay_off.png");
    private static final ResourceLocation BASE_OVERLAY = new ResourceLocation(MekanismEvolutionMod.MODID, "render/energy_cube_overlay_base.png");
    ...
    public EvoModelEnergyCube(EntityModelSet entityModelSet) {
    ...
    public void render(@Nonnull PoseStack matrix, @Nonnull MultiBufferSource renderer, int light, int overlayLight, float[] color, boolean renderMain, boolean hasEffect) {
        if (renderMain) {
            renderToBuffer(matrix, getVertexConsumer(renderer, RENDER_TYPE, hasEffect), light, overlayLight, 1, 1, 1, 1);
        }

        renderCorners(matrix, getVertexConsumer(renderer, RENDER_TYPE_BASE, hasEffect), MekanismRenderer.FULL_LIGHT, overlayLight, color[0],
                color[1], color[2], 1);
    }
    ...
    public void renderSidesBatched(@Nonnull EvoTileEntityEnergyCube tile, @Nonnull PoseStack matrix, @Nonnull MultiBufferSource renderer, int light, int overlayLight) {
    ...
    public static class ModelEnergyCore extends MekanismJavaModel {
        ...
        public void render(@Nonnull PoseStack matrix, @Nonnull MultiBufferSource renderer, int light, int overlayLight, float[] color, float energyPercentage) {
            renderToBuffer(matrix, getBuffer(renderer), light, overlayLight, color[0], color[1], color[2],
                    energyPercentage);
        }
