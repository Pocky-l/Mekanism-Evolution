 ...
 * @author Dudko Roman
 */
public class EvoDiversionTransporter extends EvoLogisticalTransporterBase {

    public final DiversionControl[] modes;
    @Nullable
    private Boolean wasGettingPower;

    public EvoDiversionTransporter(EvoTileEntityTransmitter tile) {
    ...
    public void onNeighborBlockChange(Direction side) {
        ...
        if (wasGettingPower == null || wasGettingPower != receivingPower) {
            ...
            EvoTileEntityTransmitter transmitterTile = (EvoTileEntityTransmitter) getTransmitterTile();
