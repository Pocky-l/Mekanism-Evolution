 ...
 * @author Dudko Roman
 */
public class EvoItemBlockLogisticalTransporter extends ItemBlockMultipartAble<EvoBlockLogisticalTransporter> {

    public EvoItemBlockLogisticalTransporter(EvoBlockLogisticalTransporter block) {
        super(block);
    }
